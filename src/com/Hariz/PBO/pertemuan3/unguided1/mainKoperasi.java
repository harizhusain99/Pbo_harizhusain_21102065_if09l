package com.Hariz.PBO.pertemuan3.unguided1;

public class mainKoperasi {
    public static void main(String[] args) {
        // membuat objek koperasi pertama
        Koperasi koperasi1 = new Koperasi("Buku Tulis", 5000, 10);
        ...
        Koperasi koperasi2 = new Koperasi("Pensil", 3000, 20);
        // mengisi method setter
        ...
        System.out.println("== Koperasi Hariz Maju ==");
